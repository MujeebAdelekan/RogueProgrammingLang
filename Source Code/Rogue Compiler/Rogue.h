...
#ifdef TRACEIDENTIFIERTABLE
{
   ...
   sprintf(information,"Added identifier \"%s\" at index = %d, reference = %s, identifier type = %s, data type = %s, dimensions = %d, contents type = %s",
         lexeme,identifiers,
...
--- ----- --------- ------------- ---------- -------------------------- -------------------- -------------------- 
XXX   XXX XXXXXXXXX XXXXXXXXXXXXX        XXX XXXXXXXXXXXXXXXXXXXXXXXXXX XXXXXXXXXXXXXXXXXXXX XX....               
  .     . .                                  .                          .                    .
  .     . .                                  .                          .                    .
=================================================================================================================
*/
