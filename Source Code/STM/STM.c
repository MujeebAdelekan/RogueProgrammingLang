...
---  ----------------------------- ---------------------------------------------
 ...
 12  Write hexademical integer     (*added*) Pop W16; output W16 as hexadecimal integer
         ...
         case 0XFF: 
            ...
            switch ( O16 )
            {
               ...
               case 11: // 11	Write integer	                     Pop W16; output W16 as integer
                  ...
                  break;
               case 12: // 12 Write hexademical integer /*ADDED*/   Pop W16; output W16 as hexadecimal integer
                  {
                       char datum[SOURCELINELENGTH + 1];
                  ...
                  strcat(traceLine, " write hexadecimal integer");
                  break;
...
/*** EDITING SPACE --- START ***/
               ...
               case 61: // Set file read access /*ADDED*/          Pop W16 as boolean; set read access to 'T' or 'F'.
               {
                   char datum[SOURCELINELENGTH + 1];
